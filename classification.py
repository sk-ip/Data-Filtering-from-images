...
def getInvoiceNumber(filename):
	invoices = ["INVOICE NO #", "Invoice Number", "Bill ID", "Bill No:", "Invoice Humber ", "Bill No. :"]
	with open(filename, "r") as text_file:
		ans = []
...
def getTotalAmount(filename):
	words = ["Total", "Total Amt :", "Total :", "Net Amount:", "Subtotal", "Total Invoice Value", "SUBTOTAL", "Amount :"]
	with open(filename, "r") as text_file:
		ans = []
		for line in text_file.readlines():
			for sbstr in words:
